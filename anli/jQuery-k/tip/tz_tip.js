(function($){
	$.fn.tzTip = function(options){
		...
		return this.each(function(index){
			var opts = $.extend($.fn.tzTip.defaults,$.fn.tzTip.methods,options);
			$(this).data("tzTip",JSON.stringify(opts));
			$(this).on(opts.type,function(){
				var params = JSON.parse($(this).data("tzTip"));
				var op = $.extend(params,$.fn.tzTip.parseJson.call(this));
				opts.init(op,this);
			});
	...
	//属性解析器
	$.fn.tzTip.parseJson = function(obj){
