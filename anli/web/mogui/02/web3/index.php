...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
	...
	//调用精品
	$children = get_children(9); // 表示对应栏目 id   9代表商品分类 图片定制
	$smarty->assign('index_best_goods_9', get_category_recommend_goods("best", $children)); // 热销商品 hot  best new
	
	$children = get_children(8); // 表示对应栏目 id   9代表商品分类 图片定制
	$smarty->assign('index_best_goods_8', get_category_recommend_goods("best", $children)); // 热销商品 hot  best new
	
	//调用指定分类文章
	$smarty->assign('flwenz',    get_cat_articles(4, 1, 3 )); //4栏目id  1 排   8文章个数
	$smarty->assign('flwenz2',    get_cat_articles(5, 1, 1 )); //4栏目id  1 排   8文章个数
