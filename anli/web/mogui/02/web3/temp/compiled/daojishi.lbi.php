...
<?php if (($this->_foreach['name']['iteration'] <= 1)): ?>
	...
	<?php endif; ?>
	<font style="text-decoration:line-through; color:#CCCCCC; font-size:12px;"><?php echo $this->_var['goods']['shop_price']; ?></font></a>  
	</p>
	     
	<font id="leftTime<?php echo $this->_var['key']; ?>" style=" background:url(themes/default/images/pro.gif) left center no-repeat; height:35px; line-height:35px; display:block; width:160px; margin-bottom:5px; text-indent:20px;"><?php echo $this->_var['lang']['please_waiting']; ?></font> 
