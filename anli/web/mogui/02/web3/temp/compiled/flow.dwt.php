...
?>
 	<ul class="List">
		...
		<li class="first" style="padding-top:20px">
			<?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['extension_code'] != 'package_buy'): ?>
                  <?php if ($this->_var['show_goods_thumb'] == 1): ?>
                    <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" class="f6" style="color:#000; text-decoration:none;"><?php echo $this->_var['goods']['goods_name']; ?></a>
...
<div id="goodsList" class="goodsList">
	<h3><?php if ($this->_var['allow_edit_cart']): ?><a href="flow.php" ><?php echo $this->_var['lang']['modify']; ?></a><?php endif; ?> 商品列表 </h3>
	<table>
		<tr> 
...
<?php if (! $this->_var['gb_deposit']): ?>
		<tr> <td colspan='6' class="end">
		 <?php if ($this->_var['discount'] > 0): ?><?php echo $this->_var['your_discount']; ?><br /><?php endif; ?>
             <span style="color:red;"> <?php echo $this->_var['shopping_money']; ?></span><?php if ($this->_var['show_marketprice']): ?>，<?php echo $this->_var['market_price_desc']; ?><?php endif; ?>
		</td></tr>
	<?php endif; ?>
	</table>
</div>
...
<div id="UserInfo" class="goodsList">
	<h3><a href="flow.php?step=consignee" ><?php echo $this->_var['lang']['modify']; ?></a>收货人信息 </h3>
	<table>

		<tr> 
			 <td class="title"><?php echo $this->_var['lang']['consignee_name']; ?>:</td>
             <td><?php echo htmlspecialchars($this->_var['consignee']['consignee']); ?></td>
             <td class="title"><?php echo $this->_var['lang']['email_address']; ?>:</td>
...
<div id="payType" class="goodsList">
	<h3>配送方式 </h3>
	<table>
		<tr> <th></th><th><?php echo $this->_var['lang']['name']; ?></th><th><?php echo $this->_var['lang']['describe']; ?></th><th><?php echo $this->_var['lang']['fee']; ?></th><th><?php echo $this->_var['lang']['free_money']; ?></th>
			 <th><?php echo $this->_var['lang']['insure_fee']; ?></th></tr>
 <?php $_from = $this->_var['shipping_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'shipping');if (count($_from)):
    foreach ($_from AS $this->_var['shipping']):
?>
		<tr> 
			<td class="xx" ><input name="shipping" type="radio" value="<?php echo $this->_var['shipping']['shipping_id']; ?>" <?php if ($this->_var['order']['shipping_id'] == $this->_var['shipping']['shipping_id']): ?>checked="true"<?php endif; ?> supportCod="<?php echo $this->_var['shipping']['support_cod']; ?>" insure="<?php echo $this->_var['shipping']['insure']; ?>" onclick="selectShipping(this)" /></td>
...
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		<tr> <td colspan='6' style="text-align:right;"><label for="ECS_NEEDINSURE">
                ...
                <?php echo $this->_var['lang']['need_insure']; ?> </label></td></tr>
	</table>
</div>
...
<div id="zfType" class="goodsList">
	...
	<table>
		<tr><th></th><th><?php echo $this->_var['lang']['name']; ?></th><th><?php echo $this->_var['lang']['describe']; ?></th><th><?php echo $this->_var['lang']['pay_fee']; ?></th></tr>
		 <?php $_from = $this->_var['payment_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'payment');if (count($_from)):
    foreach ($_from AS $this->_var['payment']):
?>
            
		<tr> 
			<td><input type="radio" name="payment" value="<?php echo $this->_var['payment']['pay_id']; ?>" <?php if ($this->_var['order']['pay_id'] == $this->_var['payment']['pay_id']): ?>checked<?php endif; ?> isCod="<?php echo $this->_var['payment']['is_cod']; ?>" onclick="selectPayment(this)" <?php if ($this->_var['cod_disabled'] && $this->_var['payment']['is_cod'] == "1"): ?>disabled="true"<?php endif; ?>/></td>
			<td><?php echo $this->_var['payment']['pay_name']; ?></td>
			<td class="title"><?php echo $this->_var['payment']['pay_desc']; ?></td>
...
<div id="otherType" class="goodsList">
	...
	<table>
            ...
            <tr>
              <td class="bold"><?php echo $this->_var['lang']['use_surplus']; ?>: </td>
            ...
            <tr>
              <td class="bold"><?php echo $this->_var['lang']['use_integral']; ?></td>
            ...
            <tr>
              <td  class="bold"><strong><?php echo $this->_var['lang']['use_bonus']; ?>:</strong></td>
              <td >
...
?>
            ...
            <tr>
              <td  class="bold"><?php echo $this->_var['lang']['invoice']; ?>:
            ...
            <?php endif; ?>
			 ...
			 <tr>
              <td class="bold" ><?php echo $this->_var['lang']['order_postscript']; ?>:</td>
            ...
            <tr>
              <td ><?php echo $this->_var['lang']['booking_process']; ?>:</td>
	...
	<div class="Con">
		...
		<div class="Login">
			<form action="flow.php?step=login" method="post" name="loginForm" id="loginForm" onsubmit="return checkLoginForm(this)">
				...
				<p><span>密  码：</span><input name="password" class="inputBg txt" type="password" /></p>
				<?php if ($this->_var['enabled_login_captcha']): ?>
				<p><span>验证码：</span>
				<input type="text" size="8" name="captcha" class="inputBg txt"  style="width:100px"/>
                    <img src="captcha.php?is_login=1&<?php echo $this->_var['rand']; ?>" alt="captcha" style="vertical-align: middle;cursor: pointer;" onClick="this.src='captcha.php?is_login=1&'+Math.random()" /></p>
				<?php endif; ?>
				<p><span></span>
				...
				<P> 
					 <input type="submit" class="bnt_blue but" name="login" value="<?php echo $this->_var['lang']['forthwith_login']; ?>" />
                        <?php if ($this->_var['anonymous_buy'] == 1): ?>
                        <input type="button" class="bnt_blue_2 but but2" value="允许未登录购买" onclick="location.href='flow.php?step=consignee&amp;direct_shopping=1'" />
                        <?php endif; ?>
                        <input name="act" type="hidden" value="signin" />
				
				</p>
				<p class="txt"><a href="user.php?act=qpassword_name">密码问题找回密码</a> 
								<a href="user.php?act=get_password">注册邮件找回密码</a></p>
		...
		<div class="Register">
			<form action="flow.php?step=login" method="post" name="formUser" id="registerForm" onsubmit="return checkSignupForm(this)">
				<p>	<span>用户名：</span>
				<input name="username" type="text" class="inputBg txt" id="username" onblur="is_registered(this.value);" />
					<label id="username_notice" style="color:#FF0000" ></label> 
				</p>

				<p>	<span>邮箱：</span>
				<input name="email" type="text" class="inputBg txt" id="email" onblur="checkEmail(this.value);" />
            		<label id="email_notice" style="color:#FF0000"></label> 
				</p>

				<p>	<span>密码：</span>
				<input name="password" class="inputBg txt" type="password" id="password1" onblur="check_password(this.value);" onkeyup="checkIntensity(this.value)" />
            <label style="color:#FF0000" id="password_notice"></label>
				</p>
				<p>	<span>确认密码：</span>
				<input name="confirm_password" class="inputBg txt" type="password" id="confirm_password" onblur="check_conform_password(this.value);" />
